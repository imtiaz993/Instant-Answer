...
const PreviewModal = ({ setModal, pdf }) => {
  ...
  return (
    <div className="flex justify-center md:items-center fixed z-30 top-0 bottom-0 left-0 right-0 w-screen h-screen bg-modal-overlay">
      <div className="max-h-[calc(100vh-30%)] md:max-h-[calc(100vh-15%)] relative top-[10%] md:top-0 overflow-y-auto py-4 w-11/12 md:w-full mx-auto z-10 max-w-3xl bg-white border border-darker-border rounded-lg">
