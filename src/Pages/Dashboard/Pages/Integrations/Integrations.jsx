      ...
      <div className="px-4 md:px-8 py-8 bg-white border border-[rgba(102, 112, 133, 0.2]  rounded-xl">
        <div className="grid grid-cols-2 gap-4 pb-5 border-b border-[#0000000A]">
          <div
            ...
            className="flex flex-col items-center justify-center py-8 border border-[#66708533] rounded-xl cursor-pointer"
          >
            <img src={PublicLinkIcon} alt="" />
            <p className="mt-2 text-base font-bold text-[#29303D]">
              Public Link
            </p>
          </div>
          <div
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="mt-2 text-base font-bold text-[#29303D]">Instagram</p>
          </div>
          <div
            onClick={() => {
              setModal("Messenger");
          ...
          >
            ...
            <p className="mt-2 text-base font-bold text-[#29303D]">Messenger</p>
          </div>
          <div
            onClick={() => {
              setModal("Whatsapp");
          ...
          >
            <img src={EmbededJsCodeIcon} alt="" />
            <p className="mt-2 text-base font-bold text-[#29303D]">Whatsapp</p>
          </div>
        </div>
      </div>
    </DashboardLayout>
